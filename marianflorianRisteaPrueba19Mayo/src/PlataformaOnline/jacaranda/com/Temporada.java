...
public class Temporada {
	...
	public void anadirCapituloDespues(String nombreCapituloAnnadir, String nombreCapituloAnterior) throws SerieException{
		...
		if(posicion == -1) {
			throw new SerieException("El capítulo que busca no existe");
		}
	...
	public String primerCapituloQueContieneEstaPalabara(String palabra) throws SerieException {
		...
		Iterator<String> iterator = this.capitulos.iterator();
		while(iterator.hasNext() && !encontrado) {
			String capitulo = iterator.next();
			if(capitulo.contains(palabra)) {
				resultado = capitulo;
				encontrado = true;
			}
		}
	...
	public String escribirFichero() {
		return this.nombreTemporada + ", " + this.getNumeroCapitulos() + ", " + this.sumaOpiniones + ", " + this.numeroOpiniones;
	}
